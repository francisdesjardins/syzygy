...
// `0.04045` is the sRGB transfer function's threshold; WCAG 2.x writes `0.03928`, from an early
// draft of it. No 8-bit channel falls between the two, so this picks the number a reader can look
// up. penumbra's gate holds the other copy: it judges a palette, this chooses an ink.
