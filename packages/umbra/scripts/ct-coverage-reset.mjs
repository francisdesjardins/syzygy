 ...
 * every file it finds, so a targeted run (`--grep`, one spec) writes two and silently sums the
 * fourteen a full run left behind — plausible numbers for a coverage nobody just measured.
 *
