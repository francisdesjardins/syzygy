 ...
 *
 * The same page antumbra carries, section for section, on this project's skin — the day the two
 * playgrounds share one, this file and antumbra's collapse rather than being reconciled.
 */
  ...
  return (
    ...
    >
      ...
      <ExampleSection
        id="palette"
        title="Palette"
        description="The neutrals are antumbra's, to the hex: two playgrounds that differ in their neutrals are two products. What differs is the accent, which is the one thing the split exists to vary."
      >
      ...
      <ExampleSection
        id="semantic"
        title="Semantic"
        description="Each ink pairs with the tinted surface a badge sits on. A run has four endings and three of them are on this list, which is why the set is one longer than antumbra's."
      >
        <div className={styles['grid']}>
