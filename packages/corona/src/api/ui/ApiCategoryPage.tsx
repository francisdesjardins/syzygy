import styles from './ApiCategoryPage.module.css';
...
import { useSlots } from '../slots.tsx';
...
const CategoryStep = ({
  ...
  const {
    SurfaceCard,
    icons: { ArrowBackIcon, ArrowForwardIcon },
  } = useSlots();
...
export const ApiCategoryPage = ({ categoryId }: { readonly categoryId: string }) => {
  const { PageLayout } = useSlots();
