...
/**
 * `antumbra/vanilla`, against a real browser and a `<dialog>` the caller wrote — deliberately the same
...
test.describe('antumbra/vanilla — restoreFocusTo', () => {
...
test.describe('antumbra/vanilla — moveFocus', () => {
