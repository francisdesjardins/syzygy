...
/**
 * `antumbra/react`'s `DialogOutlet`, contract unchanged, and cheaper: React must move a rendered
 ...
 * Solid component inside JSX cannot pass; the checked one is on `antumbra/react`'s `DialogOutlet`.
 */
