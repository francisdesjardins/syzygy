...
/**
 * `antumbra/solid`, against a real browser and a real `<dialog>` — deliberately the same assertions
...
test.describe('antumbra/solid — a dismissal this binding must report', () => {
 ...
 */
test.describe('antumbra/solid — the options only React had exercised', () => {
...
test.describe('antumbra/solid — focus after a failed action', () => {
 ...
 */
test.describe('antumbra/solid — reconcileOpen', () => {
...
test.describe('antumbra/solid — restoreFocusTo', () => {
...
test.describe('antumbra/solid — moveFocus', () => {
