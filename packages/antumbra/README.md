...
half.** `yarn test:unit:coverage` measures the framework-free core in Node (c8) — **96.94%**
...
~45% of the run) — **91.80%** statements over 61 files. Both measured 2026-09-18, and re-measured
