...
//
// The specifiers below are the package's real ones: `antumbra` is the framework-free library,
// `antumbra/react` is its React binding, and `react` is React. The host's import map points them at
...
import { createOpenRequest, dialogManager, Key } from 'antumbra';
