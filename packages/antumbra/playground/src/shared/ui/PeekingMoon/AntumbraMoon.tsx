/**
 * antumbra's mascot: the heraldic/woodcut sun inverted, because this is an *antumbra* — the disc
 * sits wholly inside the source, the face is cut into it in light, and the light gets all the way
 * around the rim — what `--dialog-backdrop` does to a page. Eight flames drawn from inside
 * the disc so only their tips clear the rim, each flanked by a short and a middling one, because
 * eight identical rays read as a cog. Inline, keeping the no-binary-assets rule.
 *
