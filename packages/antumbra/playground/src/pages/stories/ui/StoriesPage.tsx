    ...
    stories: [
      {
        ...
        description:
          'The shared scenario booted through antumbra/react: five steps, one of them optional and failing on purpose, and a mounted step that queues an intent and waits. The buttons are the ones the assertions press — settle releases the waiting step, drop rejects it with a reason on the record.',
      },
      {
        id: 'solid-bootstrap',
        ...
        description:
          'The same scenario through antumbra/solid, rendering the same test ids. The component suite asserts these two produce the same readout, which is the claim that keeps the bindings from drifting apart one release at a time.',
      },
    ],
  },
  {
