...
import { Key, useDialog } from 'antumbra/react';
...
const COSMIC_CSS = `
  ...
  /* The mascot's silhouette in CSS: a dark body with the corona escaping around its rim.
     A class rather than an inline style because the ring and the antumbra are pseudo-elements. */
  .cosmic-eclipse {
    position: relative;
    width: 110px;
    height: 110px;
  ...
  /* The antumbra, lit off-centre the way the mascot's disc is. */
  .cosmic-eclipse::before {
    inset: 9%;
