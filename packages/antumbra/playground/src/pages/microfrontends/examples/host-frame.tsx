 ...
 * `<script type="module">` — because a build step that resolved `antumbra` for all four would prove
 ...
 *
 * The four are written four ways on purpose: Checkout with `useDialog` from `antumbra/react`, Support
 * from `antumbra/solid`, Billing with `antumbra/vanilla` over a hand-written `<dialog>`, Audit as a web
