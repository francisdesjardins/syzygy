...
<script type="importmap">{"imports":{"antumbra":"/mfe/antumbra.mjs","antumbra/vanilla":"/mfe/antumbra-vanilla.mjs"}}</script>
</head><body>
...
<script type="module">
  ...
  const { bindDialog } = await import('antumbra/vanilla');
  const { createDialogManager } = await import('antumbra');
